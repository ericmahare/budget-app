...
RSpec.describe 'Expenditure', type: :feature do
  describe 'Expenditure' do
    before(:each) do
      ...
      @category = Category.create! name: 'group', users_id: @user.id, icon: 'Education'
      Expenditure.create! name: 'Expenditure', user_id: @user.id, amount: 20, category_id: @category.id
      Expenditure.create! name: 'new Expenditure', user_id: @user.id, amount: 20, category_id: @category.id
